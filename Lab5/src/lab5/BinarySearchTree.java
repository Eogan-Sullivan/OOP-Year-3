...
public class BinarySearchTree<E extends Comparable<E>> {
   ...
   public boolean rContains(E element)
   {
       ...
       return rContainsSub(element,root);
      
    
   }
   private boolean rContainsSub(E element,Node current){
       ...
       if(current == null) return false;
           ...
           if(result==0)
              ...
              return rContainsSub(element, current.right);
           else
            return   rContainsSub(element,current.left);
